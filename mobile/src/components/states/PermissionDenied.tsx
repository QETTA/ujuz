...
export function PermissionDenied({
  ...
  return (
    <View className={`flex-1 items-center justify-center px-6 py-16 ${className ?? ''}`}>
      ...
      <Text className="mb-2 text-center text-lg font-bold text-text-primary dark:text-dark-text-primary">
        {title ?? defaults.title}
      </Text>
      <Text className="mb-6 text-center text-sm leading-5 text-text-secondary dark:text-dark-text-secondary">
      ...
      <TouchableOpacity
        ...
        accessibilityLabel={primaryCta?.label ?? defaults.primaryLabel}
      >
