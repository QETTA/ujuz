...
| **T-306** | SMS 백업(유료 애드온) | 7 | ✅ 완료 |
| **T-403** | 캐시/레이트리밋 | 8 | ✅ 완료 |
| **T-404** | 기관 Lite(B2B) API + 기본 UI | 8 | ✅ 완료 |
...
| 티켓 | 설명 | 의존 | 상태 |
|------|------|------|------|
| **D-001** | 디자인 토큰 파이프라인 (Figma Variables → tokens.json → Tailwind/NativeWind) | — | ✅ 완료 |
| **D-002** | 접근성 표준 & 체크리스트 (WCAG 2.2 + iOS/Android 가이드) | — | ✅ 완료 |
| **D-003** | 타이포그래피 스케일 & Dynamic Type 대응 | D-001 | ✅ 완료 |
| **D-004** | 권한 UX 디자인 스펙 (프리프롬프트/거절 대체 동선) | D-001 | ✅ 완료 |
| **D-005** | 적응형/반응형 레이아웃 파운데이션 (폰/태블릿/데스크톱) | D-001 | ✅ 완료 |
| **D-006** | 상태 UI 디자인 시스템 (7종 × 카피 톤 통일) | D-001, D-002 | ✅ 완료 |
| **D-007** | Figma 파일 구조 세팅 (Pages/네이밍/모드 3종) | D-001 | 🎨 Figma 작업 |
| **D-008** | 코어 컴포넌트 10종 디자인 (버튼~상태컴포넌트) | D-001, D-002, D-003 | 🎨 Figma 작업 |
| **D-009** | 리서치 바인더 세팅 (Foundations/Platform/Product 문서) | — | ✅ 완료 |
| **D-010** | 디자인 QA 기준선 (접근성 + 알림/권한 + 핸드오프 체크) | D-002 | ✅ 완료 |
| **D-011** | P6 핵심 화면 디자인 (지도/시설상세/알림 × 상태) | D-006, D-007, D-008 | 🎨 Figma 작업 |
| **D-012** | P7 수익화 화면 디자인 (랜딩/설문/결제/리포트) | D-008 | 🎨 Figma 작업 |
| **D-013** | P8 Admin 화면 디자인 (대시보드/푸시/B2B) | D-008 | 🎨 Figma 작업 |
